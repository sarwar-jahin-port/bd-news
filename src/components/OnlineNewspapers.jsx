...
const OnlineNewspapers = () => {
    ...
    .then(data => {
      const bdata = data.filter(d => d.category === "online-newspapers")
      console.log(bdata);
      setPapers(bdata);
    })
    .catch(error => {
  ...
  return (
    <section className='w-4/5 lg:w-9/12 mx-auto'>
      <h1 className='text-3xl my-4'><span>| </span>All Online Newspapers</h1>
...
export default OnlineNewspapers